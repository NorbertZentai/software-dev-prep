...
Tervezz és implementálj egy mikroszolgáltatás architektúrát, ahol különböző szolgáltatások REST API-n és gRPC-n keresztül kommunikálnak egymással. Hasonlítsd össze a teljesítményt, fejlesztési komplexitást és üzemeltetési szempontokat.
...
## Feladat 1: REST API Mikroszolgáltatás
...
## Feladat 2: gRPC Mikroszolgáltatás
...
## Feladat 3: Performance Benchmark
...
## Feladat 4: API Gateway Integration
...
## Feladat 5: Monitoring és Telemetry
