...
export class Router {
  constructor() {
    ...
    this.routes = {
      // Theory routes
      '#/theory/java': () =>
        this.renderMarkdown('./theory/java.md', 'Java Alapok'),
      '#/theory/spring': () =>
        this.renderMarkdown('./theory/spring.md', 'Spring Framework'),
      '#/theory/testing': () =>
        this.renderMarkdown('./theory/testing.md', 'Tesztelés'),
      '#/theory/sql': () =>
        this.renderMarkdown('./theory/sql.md', 'SQL & Adatbázis'),
      '#/theory/web': () =>
        this.renderMarkdown('./theory/web.md', 'Web Development'),
      '#/theory/arch': () =>
        this.renderMarkdown('./theory/arch.md', 'Architektúra'),
      '#/theory/git': () =>
        this.renderMarkdown('./theory/git.md', 'Git & Verziókezelés'),
      '#/theory/softskills': () =>
        this.renderMarkdown('./theory/softskills.md', 'Soft Skills'),
